...
{menu && (
  <div className="md:hidden fixed top-16 left-0 w-full bg-white/10 text-white flex flex-col items-center gap-6 py-6 z-50 backdrop-blur-md border-y border-white/20">
